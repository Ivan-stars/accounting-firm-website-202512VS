...
required_texts = [
    ...
    "Risk Management",
    "Core Services",
    "Professional audit reports ensuring financial transparency and compliance",
    "Optimize tax structures to legally maximize tax benefits",
    "Strategic business advice for stable corporate development"
]

doc = Document()
doc.add_heading('Raymond C W Tam and Co. Services Content (English)', 0)
...
if missing:
    ...
    doc.save('Services.docx')
    print('Exported Services page content to Services.docx (all required texts found)') 