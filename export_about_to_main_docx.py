...
doc = Document()
doc.add_heading('Raymond C W Tam and Co. About Us Content (English)', 0)
...
if missing:
    ...
    doc.save('About_Us.docx')
    print('Exported About Us page content to About_Us.docx (all required texts found)') 